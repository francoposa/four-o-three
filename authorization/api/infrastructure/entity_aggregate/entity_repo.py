...
from authorization.api.infrastructure.datastore.postgres import (
    CHILD_ENTITY_TABLE,
    ENTITY_CHILD_ENTITY_TABLE,
    ENTITY_TABLE,
)
from authorization.api.infrastructure.entity_aggregate.entity_repo_adapter import EntityRepoAdapter
